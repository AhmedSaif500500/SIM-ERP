      ...
      (E.jstree.core.prototype = {
        ...
        _load_nodes: function (e, t, i, r) {
          for (
            ...
            n[e[o]] &&
              ((!n[e[o]].state.loaded && !n[e[o]].state.failed) || (!i && r)) &&
              (this.is_loading(e[o]) || this.load_node(e[o], a), (s = !1));
          if (s) {
        ...
        _append_html_data: function (e, t, i) {
          ...
          for (
            t.each(
              function (e, t) {
                (d = this._parse_model_from_html(
                  ...
                  (s.push(d),
                    a.push(d),
                    n[d].children_d.length && (a = a.concat(n[d].children_d)));
              }.bind(this)
            ),
            o.children = s,
            o.children_d = a,
            ...
            n[o.parents[c]].children_d = n[o.parents[c]].children_d.concat(a);
              ...
              a = function (e, c) {
                var t = (e = e.data ? e.data : e).dat,
                  ...
                  m = function (e, t, i) {
                    ...
                    if (
                      (e && (e.id || 0 === e.id) && (d.id = e.id.toString()),
                    ...
                    return (
                      ...
                      delete e.children,
                      (d.original = e),
                      (u[d.id] = d).state.selected && l.push(d.id),
                      d.id
                    );
                  };
                if (t.length && t[0].id !== c && t[0].parent !== c) {
                  ...
                  for (o = 0, d = t.length; o < d; o++)
                    u[t[o].parent.toString()]
                      ? (u[t[o].parent.toString()].children.push(
                        t[o].id.toString()
                      ),
                        a.children_d.push(t[o].id.toString()))
                      : void 0 !== v &&
                  ...
                  for (o = 0, d = a.children.length; o < d; o++)
                    (n = p(u[a.children[o]], i, a.parents.concat())),
                      s.push(n),
                      u[n].children_d.length && (s = s.concat(u[n].children_d));
                  for (o = 0, d = a.parents.length; o < d; o++)
                    u[a.parents[o]].children_d =
                      u[a.parents[o]].children_d.concat(s);
              ...
              n = function (e, t) {
                if (null !== this.element) {
                  ...
                  if (((this._model.data = e.mod), t)) {
                    ...
                    if (
                      n.length !== o.length ||
                      E.vakata.array_unique(n.concat(o)).length !== n.length
                    ) {
                    ...
                    ? ((this._data.core.working = !0),
                      ...
                      s.par
                        ...
                        : this._data.core.worker_queue.length
                          ...
                          : (this._data.core.working = !1))
                    : this._data.core.worker_queue.push([e, t, d, !0]);
              } catch (e) {
                n.call(this, a(s), !1),
                  this._data.core.worker_queue.length
                    ? this._append_json_data.apply(
        ...
        _parse_model_from_json: function (e, t, i) {
          ...
          if (e && e.children && e.children.length) {
            for (s = 0, a = e.children.length; s < a; s++)
              (o =
                d[(n = this._parse_model_from_json(e.children[s], l.id, i))]),
                l.children.push(n),
                o.children_d.length &&
                (l.children_d = l.children_d.concat(o.children_d));
          ...
          return (
            ...
            delete e.children,
            (l.original = e),
            (d[l.id] = l).state.selected && this._data.core.selected.push(l.id),
            l.id
          );
        },
        _redraw: function () {
        ...
        redraw_node: function (e, t, i, r) {
            ...
            (e = E(e)),
              ...
              (t =
                !t &&
                  ...
                  ? !0
                  : t) || (o = e.children(".jstree-children")[0]),
          ...
          if (
            ...
            g[s.parent] &&
            !s.state.hidden &&
            ((d = E.inArray(s.id, g[s.parent].children)), (k = s.id), -1 !== d)
          )
          ...
          if (
            ...
            for (
              ...
              l.appendChild(this.redraw_node(s.children[d], t, !0));
            e.appendChild(l);
          }
          if ((o && e.appendChild(o), !i)) {
            for (
              d = 0, c = (a = a || this.element[0]).childNodes.length;
              d < c;
              d++
            )
              if (
                ...
                -1 !== a.childNodes[d].className.indexOf("jstree-children")
              ) {
                p = a.childNodes[d];
                break;
              }
        ...
        create_node: function (e, t, i, r, s) {
          ...
          for (t = a, a = [], o = 0, d = e.children.length; o < d; o++)
        ...
        cut: function (e) {
          ...
          (a = t), (n = "move_node"), (o = this).trigger("cut", { node: e });
        },
        copy: function (e) {
          if (
            ((e = e || this._data.core.selected.concat()),
          ...
          for (var t = [], i, r, s, r = 0, s = e.length; r < s; r++)
            (i = this.get_node(e[r])) &&
              ...
              t.push(i);
          if (!t.length) return !1;
          (a = t), (n = "copy_node"), (o = this).trigger("copy", { node: e });
        },
        get_buffer: function () {
          ...
          return (
            ...
            (this.check("edit", r, this.get_parent(r))
              ? ((l = r),
                ...
                (c = E("<input />", {
                  ...
                  blur: function (e) {
                    ...
                    "" === i && (i = o),
                      ...
                      (o = e
                        ? o
                        : E("<div></div>").append(E.parseHTML(o)).html()),
                      (r = this.get_node(r)),
                      this.set_text(r, o),
                      (e = !!this.rename_node(
                        r,
                ...
                c
                  .css(t)
                  .width(Math.min(d.text("pW" + c[0].value).width(), i))[0]
                  .select(),
                void E(b).one(
        ...
        (this.bind = function () {
                  ...
                  if (-1 !== t.indexOf("down"))
                    if (r.state[_ ? "selected" : "checked"]) {
                      for (o = 0, d = s.length; o < d; o++)
                        i[s[o]].state[_ ? "selected" : "checked"] = !0;
                      ...
                      for (o = 0, d = s.length; o < d; o++)
                        if (i[s[o]].state[_ ? "selected" : "checked"]) {
                          for (
                            c = 0, l = i[s[o]].children_d.length;
                            c < l;
                            c++
                          )
                            i[i[s[o]].children_d[c]].state[
                              _ ? "selected" : "checked"
                            ] = !0;
                          this._data[_ ? "core" : "checkbox"].selected =
                            this._data[
                              _ ? "core" : "checkbox"
                            ].selected.concat(i[s[o]].children_d);
                        }
                  if (-1 !== t.indexOf("up")) {
                    for (o = 0, d = r.children_d.length; o < d; o++)
                      i[r.children_d[o]].children.length ||
                    ...
                    for (
                      ...
                      while (r && r.id !== E.jstree.root) {
                        for (o = n = 0, d = r.children.length; o < d; o++)
                          n +=
                            i[r.children[o]].state[
                            _ ? "selected" : "checked"
                            ];
                        if (n !== d) break;
                ...
                function (e, t) {
                  ...
                  if (-1 !== t.indexOf("up"))
                    while (a && a.id !== E.jstree.root) {
                      for (n = d = 0, o = a.children.length; n < o; n++)
                        d +=
                ...
                function (e, t) {
                  ...
                  if (
                    ...
                    for (a = 0, n = r.parents.length; a < n; a++)
                      ((o = this._model.data[r.parents[a]]).state[
                        c ? "selected" : "checked"
                      ] = !1),
                        o &&
                        o.original &&
                ...
                function (e, t) {
                  ...
                  if (!i) {
                    ...
                    while (
                      ...
                      for (o = n = 0, d = a.children.length; o < d; o++)
                        n +=
                          s[a.children[o]].state[l ? "selected" : "checked"];
                      if (!(0 < d && n === d)) break;
                      (a.state[l ? "selected" : "checked"] = !0),
                  ...
                  while (a && a.id !== E.jstree.root) {
                    for (o = n = 0, d = a.children.length; o < d; o++)
                      n += s[a.children[o]].state[l ? "selected" : "checked"];
                    if (n === d)
                      a.state[l ? "selected" : "checked"] ||
                        ((a.state[l ? "selected" : "checked"] = !0),
                          this._data[l ? "core" : "checkbox"].selected.push(
              ...
              if (o[d[i]] && o[d[i]].parents)
                for (s = 0, a = o[d[i]].parents.length; s < a; s++) {
                  ...
                  o[d[i]].parents[s] !== E.jstree.root &&
                    ((n[o[d[i]].parents[s]] = !0), c.push(o[d[i]].parents[s]));
                }
            for (
              this.element
                .find(".jstree-closed")
                ...
                .each(function () {
                  ...
                  if (e)
                    if (e.state.loaded) {
                      for (i = 0, r = e.children_d.length; i < r; i++)
                        if (
                          !(t = o[e.children_d[i]]).state.loaded &&
                          t.original &&
                          t.original.state &&
          ...
          (this.redraw_node = function (e, t, i, r) {
            if ((e = d.redraw_node.apply(this, arguments))) {
              for (
                var s, a, n = null, o = null, s = 0, a = e.childNodes.length;
                s < a;
                s++
              )
                if (
          ...
          (this.load_node = function (e, t) {
            ...
            if (
              ...
              for (i = 0, r = o.children_d.length; i < r; i++)
                this._model.data[o.children_d[i]].state.checked &&
                  (this._data.checkbox.selected = E.vakata.array_remove_item(
                    this._data.checkbox.selected,
                    o.children_d[i]
                  ));
        ...
        (this.bind = function () {
          ...
          (this.show_contextmenu = function (t, i, r, e) {
            ...
            (!s.show_at_node && i !== P && r !== P) ||
              ...
              E.isPlainObject(d) && this._show_contextmenu(t, i, r, d);
          }),
          ...
          (e = h(e)).length &&
            ...
            ((t = e.children("ul")),
              ...
              _
                ...
                : e[o < r + a && o - r < i ? "addClass" : "removeClass"](
          ...
          if (
            ...
            return (
              ...
              ((e = f(b)),
                ...
                (d = e.scrollLeft()),
                s < r &&
                i.pageY - o < f.vakata.dnd.settings.scroll_proximity &&
                (p.scroll_t = -1),
                s < r &&
                s - (i.pageY - o) < f.vakata.dnd.settings.scroll_proximity &&
                (p.scroll_t = 1),
                n < a &&
                i.pageX - d < f.vakata.dnd.settings.scroll_proximity &&
                (p.scroll_l = -1),
                n < a &&
                n - (i.pageX - d) < f.vakata.dnd.settings.scroll_proximity &&
                (p.scroll_l = 1),
                  ...
                  if (this._data.search.som && t.res.length) {
                    for (
                      ...
                      if (
                        ...
                        for (
                          n = 0, o = i[t.res[r]].children_d.length;
                          n < o;
                          n++
                        )
                ...
                for (
                  ...
                  if (
                    ((o = "default"),
                      ...
                      s[o].icon !== P &&
                      (i[r[a]].icon = s[o].icon),
                      s[o].li_attr !== P && "object" == typeof s[o].li_attr)
                  )
                    ...
                    for (d in s[o].a_attr)
                      s[o].a_attr.hasOwnProperty(d) &&
                        ...
                        (i[r[a]].a_attr[d] === P
                          ...
                          : "href" === d && "#" === i[r[a]].a_attr[d]
                            ? (i[r[a]].a_attr.href = s[o].a_attr.href)
                            : "class" === d &&
                            (i[r[a]].a_attr.class =
                              s[o].a_attr.class + " " + i[r[a]].a_attr.class));
                }
          ...
          (this.get_json = function (e, t, i) {
            ...
            if (E.vakata.is_array(o))
              for (r = 0, s = o.length; r < s; r++)
                (o[r].type =
                  (o[r].id || 0 === o[r].id) && a[o[r].id] && a[o[r].id].type
                    ? a[o[r].id].type
                    : "default"),
                  t &&
                  t.no_id &&
                  (delete o[r].id,
                    o[r].li_attr && o[r].li_attr.id && delete o[r].li_attr.id,
                    o[r].a_attr && o[r].a_attr.id && delete o[r].a_attr.id);
            else
              (o.type =
              ...
              case "copy_node":
                if ("move_node" !== e || -1 === E.inArray(t.id, i.children)) {
                  ...
                  if (a && t.children_d && t.parents) {
                    for (d = o = 0, c = t.children_d.length; d < c; d++)
              ...
              for (d in r[n].li_attr)
                r[n].li_attr.hasOwnProperty(d) &&
                  ...
                  ("class" === d
                    ...
                    : i[e.id].li_attr[d] === r[n].li_attr[d] &&
                    ((i[e.id].li_attr[d] = null), c && c.removeAttr(d)));
              ...
              for (d in r[n].a_attr)
                r[n].a_attr.hasOwnProperty(d) &&
                  ...
                  ("class" === d
                    ...
                    : i[e.id].a_attr[d] === r[n].a_attr[d] &&
                    ("href" === d
                      ? ((i[e.id].a_attr[d] = "#"), l && l.attr("href", "#"))
                      : (delete i[e.id].a_attr[d], l && l.removeAttr(d))));
              ...
              for (d in r[t].li_attr)
                r[t].li_attr.hasOwnProperty(d) &&
                  ...
                  (i[e.id].li_attr[d] === P
                    ...
                    : "class" === d &&
                    ((i[e.id].li_attr.class =
                      r[t].li_attr[d] + " " + i[e.id].li_attr.class),
        ...
        (this.check = function (e, t, i, r, s) {
          ...
          for (
            ...
            (_ = c[i.children[l]].text),
              o || (_ = _.toLowerCase()),
              d && (_ = _.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")),
              n.push(_);
          switch (
          (o || (a = a.toLowerCase()),
            d && (a = a.replace(/^[\s\uFEFF\xA0]+|[\s\uFEFF\xA0]+$/g, "")),
            e)
          ) {
            case "delete_node":
              return !0;
