...
document.querySelector("#btn_save").addEventListener("click", async function () {
    try {
      ...
      // let table_permission_employees = parseInt(document.querySelector("#table_permission_employees").value); // 5aleha let msh const
      // let table_permission_effects = parseInt(document.querySelector("#table_permission_effects").value); // 5aleha let msh const
