...
const cash_rc_update_data = JSON.parse(sessionStorage.getItem('cash_rc_update_data'));
// sessionStorage.removeItem(`purshases_invoice_update_data`)

if (!cash_rc_update_data){
