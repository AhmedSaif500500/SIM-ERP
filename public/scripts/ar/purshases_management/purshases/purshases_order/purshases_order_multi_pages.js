...
async function showPurshasesOrderData(x,qutation_id,type){
  ...
  purshasesQutationReferencesArray =  Data.purshasesQutationReferencesArray;
    ...
    if (!Data || !taxHeaderArray || !itemsDataArray || !bodyDataArray){
    ...
    create_drop_down_with_External_DataArray(`dropdown_div4`,purshasesQutationReferencesArray); selectedRow_dropdownDiv(`dropdown_div4`,purshasesQutationReferencesArray,qutationId);
