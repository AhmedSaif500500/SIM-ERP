...
let purshasesQutationReferencesArray = [];
let purshasesOrderReferencesArray = [];
...
async function showpurshasesInvoiceData(x, qutationId, orderId, type){
  ...
  Data = await new_fetchData_postAndGet(
    ...
    false,false,
    false,false,false,
    false,"purshases_invoice_view_ar",
  ...
  purshasesOrderReferencesArray =  Data.purshasesOrderReferencesArray;
    ...
    create_drop_down_with_External_DataArray(`dropdown_div4`,purshasesOrderReferencesArray); selectedRow_dropdownDiv(`dropdown_div4`,purshasesOrderReferencesArray,order_id);
    create_drop_down_with_External_DataArray(`dropdown_div5`,purshasesQutationReferencesArray); selectedRow_dropdownDiv(`dropdown_div5`,purshasesQutationReferencesArray,qutation_id);
