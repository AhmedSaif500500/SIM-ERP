...
pagePermission("items_permission", "update");
...
function showData(){
    ...
    if (obj_items_update_account){
        ...
        select_parents_group_select.innerHTML = obj_items_update_account.items_options;
        select_parents_group_select.value = obj_items_update_account.parentNode
        
        revenue_account_select.innerHTML = obj_items_update_account.revenue_accounts_options;
        revenue_account_select.value = obj_items_update_account.item_revenue_account_id

        tree_add_account.style.display = 'flex'
    }
    
}
btn_update_account.onclick = async function updateAccount() {
    try {
        // prepare data
        ...
        const account_parent_id = parseInt(select_parents_group_select.value);
