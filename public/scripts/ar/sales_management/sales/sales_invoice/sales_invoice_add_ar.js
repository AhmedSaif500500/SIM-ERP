...
const is_RowTax  = is_RowTax_checkBox.checked
  ...
  if (tableRows.length > 0) { // التأكد من وجود بيانات داخل المصفوفه اولا
    ...
    const posted_Obj = {customerId, total, datex, dueDate, orderReferenceId, qutationReferenceId, itemLocationId, salesmanId, is_RowNote, is_RowDiscount, is_RowTax, general_note, location_name, posted_array}
...
document.addEventListener('DOMContentLoaded', async function () {
  ...
  if (convertToInvoice && convertToInvoice.qutationToInvoice){
    ...
    salesOederReferencesArray =  Data.salesOederReferencesArray;
      ...
      create_drop_down_with_External_DataArray(`dropdown_div4`,salesOederReferencesArray)
      create_drop_down_with_External_DataArray(`dropdown_div5`,salesQutationReferencesArray)
