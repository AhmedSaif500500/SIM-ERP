                  ...
                  <td style="width: auto; height: var(--input_height);">
                    <div class="dropdown_container_input_table" id="">
                      <div class="row h_full">
                        ...
                        <!-- items -->
                         <div class="row items_div" style="gap:0.2rem;">
                            <div class="row">
                            ...
                            <div class="row itemLocation_div">
...
function change_select_account_type(select) {
  ...
  if (val === 5) {
    ...
    tr.querySelector(`.itemLocation_div`).style.display = 'flex'
  } else if (val === 8) {
    tr.querySelector(`.itemLocation_div`).style.display = 'none'
