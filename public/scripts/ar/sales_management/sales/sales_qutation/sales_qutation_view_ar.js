...
function fillTable() {
    try {
        ...
        let style_note = `display:${f4_checkbox.checked ? "table-cell" : "none"}; min-width: 20rem; width: 100%; white-space: wrap; text-align: start;`;
        ...
        slice_array1.forEach((row) => {
            ...
            if(row.qutation_status === 'مقبول'){
                qutationstatusClass = 'table_blue_condition'
