...
const is_RowTax  = is_RowTax_checkBox.checked
  ...
  if (tableRows.length > 0) { // التأكد من وجود بيانات داخل المصفوفه اولا
    ...
    const posted_Obj = {customerId, total, datex, invoiceReferenceId, itemLocationId, salesmanId, is_RowNote, is_RowDiscount, is_RowTax, general_note, location_name, posted_array}
